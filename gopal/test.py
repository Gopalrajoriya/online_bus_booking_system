...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\n\n\n\nName: Gopal Rajoriya", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B123", font='Arial 16 bold', fg='blue').pack()
                                            ...
                                            if len(name)>0 and len(name)<20:
                                                if age>0 and age<150:
                                                    if seats>0 and seats<200:
                                                        ...
                                                        showerror("booking limit exceed","invalid input")
                                                else:
